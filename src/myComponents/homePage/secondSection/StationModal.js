                    ...
                    >
                      ...
                      >
                        {element.station_facility[0] ? (
                          <div class="relative flex flex-col items-center group">
                            ...
                            <div class="absolute bottom-0 flex flex-col items-center hidden mb-8 group-hover:flex">
                              <span class="relative left-2 z-10 px-2 pt-2 pb-3 text-xs text-white whitespace-no-wrap bg-[#00308F] shadow-lg rounded-md pointer-events-none w-max ">
                                Divyang friendly station.
                              </span>
                              <div class="relative left-2 w-3 h-3 z-10 -mt-2 rotate-45 bg-[#00308F]"></div>
                            </div>
                          </div>
                        ) : null}
                        ...
                        {element.station_facility[3] ? (
                          // <i class="fi fi-br-shuffle pl-4 pt-3"></i>
                          <div class="relative flex flex-col items-center group">
                            <span className="fi fi-br-shuffle  text-black pl-4 pt-3  cursor-pointer"></span>
                            <div class="absolute bottom-0 flex flex-col items-center hidden mb-8 group-hover:flex">
                              <span class="relative left-2 z-10 px-2 pt-2 pb-3 text-xs leading-none text-white whitespace-no-wrap bg-[#00308F] shadow-lg rounded-md pointer-events-none w-max">
