...
import MetroLogo from '../images/metroLogo.jpg'
      ...
      <div className="justify-between px-4  lg:max-w-7xl md:items-center md:flex md:px-8">
        <div className="flex items-center justify-start py-3 md:py-4 md:flex">
          <div className=" flex md:hidden mr-2">
            <button
              className="p-2 
                 text-gray-700 rounded-md outline-none "
          ...
          <div className="flex items-center ">
            <div ><img className='logo w-10 ' src={MetroLogo} alt='logo' /></div>
            <div><h2 className="text-2xl font-bold  px-1 ">SMR</h2></div>
          </div>
        </div>
                ...
                <div>
                  <form action='search'>
                    ...
                    <div className=" flex relative  md:flex">
                      ...
                      <input type="search" id="search-navbar" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." />
                    </div>
                  </form>
                </div>
              </li>
